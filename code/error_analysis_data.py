...
def convert_data_to_ids(tokenizer, text, y_str):    
...
def data_helper_bert(x_train_all,x_val_all,x_test_all,model_select):        
    x_train, y_train, y_train_str = x_train_all[0],x_train_all[1],x_train_all[2]
    x_val, y_val, y_val_str = x_val_all[0],x_val_all[1],x_val_all[2]
    x_test, y_test = x_test_all[0],x_test_all[1]
    ...
    x_train_input_ids, x_train_seg_ids, x_train_atten_masks, x_train_mask = convert_data_to_ids(tokenizer, x_train,y_train_str)
    x_val_input_ids, x_val_seg_ids, x_val_atten_masks, x_val_mask = convert_data_to_ids(tokenizer, x_val, y_val_str)
    x_test_input_ids, x_test_seg_ids, x_test_atten_masks, x_test_mask = convert_data_to_ids(tokenizer, x_test, None)
