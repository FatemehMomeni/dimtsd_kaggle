...
def run_classifier():
    ...
    for target_index in range(len(target_word_pair)):
        ...
        for seed in random_seeds:    
            ...
            x_train = train['Tweet'].values.to_list()
            x_train_target = train['Target'].values.to_list()
            y_train = train['Stance'].values.to_list()
            x_train_rel1 = train['RelatedTarget1'].values.to_list()
            x_train_rel2 = train['RelatedTarget2'].values.to_list()
            x_train_rel3 = train['RelatedTarget3'].values.to_list()
            
            x_val = val['Tweet'].values.to_list()
            x_val_target = val['Target'].values.to_list()
            y_val = val['Stance'].values.to_list()
            x_val_rel1 = val['RelatedTarget1'].values.to_list()
            x_val_rel2 = val['RelatedTarget2'].values.to_list()
            x_val_rel3 = val['RelatedTarget3'].values.to_list()
            
            x_test = test['Tweet'].values.to_list()
            x_test_target = test['Target'].values.to_list()
            y_test = test['Stance'].values.to_list()
            x_test_rel1 = test['RelatedTarget1'].values.to_list()
            x_test_rel2 = test['RelatedTarget2'].values.to_list()
