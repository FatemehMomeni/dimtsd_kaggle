...
def convert_data_to_ids(tokenizer, target, rel1, rel2, rel3, text):    
...
def data_helper_bert(x_train_all,x_val_all,x_test_all,main_task_name,model_select):    
    ...
    x_train,y_train,x_train_target, x_train_rel1, x_train_rel2, x_train_rel3 = x_train_all[0],x_train_all[1],x_train_all[2], x_train_all[3], x_train_all[4], x_train_all[5]
    x_val,y_val,x_val_target, x_val_rel1, x_val_rel2, x_val_rel3 = x_val_all[0],x_val_all[1],x_val_all[2], x_val_all[3], x_val_all[4], x_val_all[5]
    x_test,y_test,x_test_target, x_test_rel1, x_test_rel2, x_test_rel3 = x_test_all[0],x_test_all[1],x_test_all[2], x_test_all[3], x_test_all[4], x_test_all[5]
    ...
    x_train_input_ids, x_train_seg_ids, x_train_atten_masks, x_train_len = \
                    convert_data_to_ids(tokenizer, x_train_target, x_train_rel1, x_train_rel2, x_train_rel3, x_train)
    x_val_input_ids, x_val_seg_ids, x_val_atten_masks, x_val_len = \
                    convert_data_to_ids(tokenizer, x_val_target, x_val_rel1, x_val_rel2, x_val_rel3, x_val)
    x_test_input_ids, x_test_seg_ids, x_test_atten_masks, x_test_len = \
                    convert_data_to_ids(tokenizer, x_test_target, x_test_rel1, x_test_rel2, x_test_rel3, x_test)
